...
function DeleteUser({ onDelete, onClose }) {
  return (
    <div className="bg-white p-6 w-[25rem] lg:w-full flex flex-col gap-4 items-center text-center relative rounded-2xl">
      ...
      <p className="font-bicubik text-2xl dark:text-white">Delete user</p>
      <p className="text-gray text-xl">Are you sure to delete this user?</p>
      ...
      <div className="border border-gray_lighter rounded-xl w-full dark:border-green_11">
        ...
        <p className="font-semibold text-xl dark:text-white">Nick Charles</p>
      </div>
